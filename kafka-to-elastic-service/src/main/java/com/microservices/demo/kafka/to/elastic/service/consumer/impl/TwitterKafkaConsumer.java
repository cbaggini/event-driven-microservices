...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    public void onAppStarted(ApplicationStartedEvent event) {
        ...
        LOG.info("Topics {} ready for operation", kafkaConfigData.getTopicNamesToCreate().toArray());
    ...
    public void receive(@Payload List<TwitterAvroModel> messages,
        ...
        LOG.info("{} messages received with keys {}, partitions {} and offsets {}, sending to elastic thread {}",
                messages.size(),
                keys.toString(),
                partitions.toString(),
                offsets.toString(),
                Thread.currentThread().getId());
        List<TwitterIndexModel> twitterMessages = avroToElasticModelTransformer.getElasticModels(messages);
        List<String> documentIds = elasticIndexClient.save(twitterMessages);
